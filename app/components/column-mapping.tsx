  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Ordne die CSV-Spalten den Shopify-Feldern zu</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {!isValid && (
          <Alert variant="destructive">
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>Mindestens SKU oder Name muss zugeordnet werden.</AlertDescription>
          </Alert>
        )}
