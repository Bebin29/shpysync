  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Lade deine CSV- oder DBF-Datei mit Produktdaten hoch</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {selectedFilePath ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {selectedFilePath.toLowerCase().endsWith(".dbf") ? "DBF-Datei" : "CSV-Datei"}{" "}
                  ausgewählt
                </p>
              </div>
            </div>
          ...
          >
            <Upload
              className={`mb-4 h-12 w-12 ${isDragging ? "text-blue-500" : "text-gray-400"}`}
            />
